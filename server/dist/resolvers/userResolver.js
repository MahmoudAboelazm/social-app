...
let UserResolver = class UserResolver {
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(constants_1.FORGET_PASSOWORD + token, user.id, "ex", 1000 * 60 * 60 * 24 * 3);
            console.log(token);
            yield sendMail_1.sendEmail(email, `<a href="http://localhost:3000/change-password/${token}">set your password<a/>`);
            return true;
        });
    }
    resetPassord(newPassword, token, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const key = constants_1.FORGET_PASSOWORD + token;
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserResolver.prototype, "resetPassord", null);
__decorate([
